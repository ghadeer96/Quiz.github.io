...
if ($("input[@name=q1]:checked").val() != "Ellen")
count++;

if ($("input[@name=q2]:checked").val() != "Elliot")
count++;

if ($("input[@name=q3]:checked").val() != "Swift")
count++;

if ($("input[@name=q4]:checked").val() != "1983")
count++;

if ($("input[@name=q5]:checked").val() != "Donut")
count++;

if ($("input[@name=q6]:checked").val() != "2016")
count++;

if ($("input[@name=q7]:checked").val() != "Frozen")
count++;

if ($("input[@name=q8]:checked").val() != "Pied Piper")
count++;

if ($("input[@name=q9]:checked").val() != "Work work work work..")
count++;

if ($("input[@name=q10]:checked").val() != "Space Invaders")
count++;
...
*/
var catStr = 'You answered' + count + 'questions correctly.';
